export const TEST_CONFIGURATIONS: Record<string, string> = {
  ...
  // Token Service Tests
  TokenAirdropCancel: "src/tests/token-service/test-token-airdrop-cancel-transaction.ts",
  TokenAirdropClaim: "src/tests/token-service/test-token-airdrop-claim-transaction.ts",
  ...
  TokenDissociate: "src/tests/token-service/test-token-dissociate-transaction.ts",
  TokenFeeScheduleUpdate: "src/tests/token-service/test-token-fee-schedule-update-transaction.ts",
  ...
  TokenRevokeKyc: "src/tests/token-service/test-token-revoke-kyc-transaction.ts",
