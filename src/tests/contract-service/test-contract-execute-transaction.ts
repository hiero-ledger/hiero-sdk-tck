...
// Bytecode from contract-execute.sol
...
describe("ContractExecuteTransaction", function () {
  ...
  describe("Contract ID", function () {
    ...
    it("(#4) Execute a contract with deleted contract ID", async function () {
      ...
      expect(executeResponse.status).to.equal("SUCCESS");
    });
  ...
  describe("Gas", function () {
    ...
    it("(#4) Execute contract with gas = int64 min", async function () {
      try {
        await JSONRPCRequest(this, "executeContract", {
          contractId,
    ...
    it("(#5) Execute contract with gas = int64 min + 1", async function () {
      try {
        await JSONRPCRequest(this, "executeContract", {
          contractId,
    ...
    it("(#6) Execute contract with insufficient gas for function", async function () {
      try {
        await JSONRPCRequest(this, "executeContract", {
          contractId,
          gas: "1000",
    ...
    it("(#7) Execute contract with no gas specified", async function () {
      try {
        await JSONRPCRequest(this, "executeContract", {
          contractId,
          functionParameters: toHexString(constructorParams),
