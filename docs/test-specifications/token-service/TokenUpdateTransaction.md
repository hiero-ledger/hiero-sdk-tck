...
| 12      | Updates a mutable token with an auto renew period set to 8,000,002 seconds                                   | tokenId=<CREATED_MUTABLE_TOKEN_ID>, autoRenewPeriod="8000002", commonTransactionParams.signers=[<CREATED_MUTABLE_TOKEN_ADMIN_KEY>]              | The token update fails with an AUTORENEW_DURATION_NOT_IN_RANGE response code from the network. | Y                 |
