...
| 13      | Verify adminKey field when set                     | Topic with adminKey                       | Returns the correct admin key                                                 | N                 |
| 14      | Verify adminKey field when not set                 | Topic without adminKey                    | Returns null or empty for adminKey                                            | N                 |
| 15      | Verify submitKey field when set                    | Topic with submitKey                      | Returns the correct submit key                                                | N                 |
| 16      | Verify submitKey field when not set                | Topic without submitKey                   | Returns null or empty for submitKey                                           | N                 |
| 17      | Verify autoRenewAccountId with custom account      | Topic with autoRenewAccountId set         | Returns the correct auto-renew account ID                                     | N                 |
| 18      | Verify autoRenewAccountId with default             | Topic without explicit autoRenewAccountId | Returns the default auto-renew account ID                                     | N                 |
| 19      | Verify autoRenewPeriod field                       | Topic with custom autoRenewPeriod         | Returns the correct auto-renew period in seconds                              | N                 |
| 20      | Verify feeScheduleKey field when set               | Topic with feeScheduleKey                 | Returns the correct fee schedule key                                          | N                 |
| 21      | Verify feeScheduleKey field when not set           | Topic without feeScheduleKey              | Returns null or empty for feeScheduleKey                                      | N                 |
| 22      | Verify feeExemptKeys field when set                | Topic with feeExemptKeys                  | Returns the correct fee exempt keys array                                     | N                 |
| 23      | Verify feeExemptKeys field when not set            | Topic without feeExemptKeys                | Returns null or empty array for feeExemptKeys                                 | N                 |
| 24      | Verify customFees field with no fees               | Topic without custom fees                 | Returns an empty array for customFees                                         | N                 |
| 25      | Verify customFees field with fixed fee             | Topic with fixed fee                      | Returns the correct fixed fee in customFees array                             | N                 |
| 26      | Verify ledgerId field                              | Any valid topic                           | Returns the correct ledger ID                                                 | N                 |