...
| 6       | Updates a topic with too large expiration time                                               | topicId="<CREATED_TOPIC_ID>", expirationTime=<CURRENT_TIME + 8000002>       | The topic update fails with `INVALID_EXPIRATION_TIME`.               | N                 |
