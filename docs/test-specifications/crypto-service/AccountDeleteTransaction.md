...
| 3       | Deletes an admin account                                          | deleteAccountId="0.0.2", transferAccountId=<OPERATOR_ACCOUNT_ID>, commonTransactionParams.signers=[<PRIVATE_KEY_OF_CREATED_ACCOUNT>]              | The account deletion fails with an ENTITY_NOT_ALLOWED_TO_DELETE response code from the network.             | Y                 |
