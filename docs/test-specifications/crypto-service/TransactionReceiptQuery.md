...
| 2       | Query for the receipt with no transaction ID                          |                                                                    | The receipt query fails and returns error response INVALID_TRANSACTION_ID                   | Y                 |
| 3       | Query for the receipt of a transaction that doesn't exist             | transactionId=0.0.99999-1234567890-000000000                       | The receipt query fails with an internal error after SDK retries on RECEIPT_NOT_FOUND       | Y                 |
...
| 11      | Verify receipt exchangeRate is returned                               | transactionId=<VALID_TRANSACTION_ID>                               | The receipt contains a valid exchangeRate with hbars and cents                              | Y                 |
