...
| 6       | Query the balance of an account that doesn't exist    | accountId=123.456.789                                          | The query succeeds and returns `hbars` `"0"` — the balances endpoint reports no entry, not an error                            | Y                 |
