...
| 2       | Execute a contract without contract ID             | parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>                                   | Transaction succeeds because of EVM compatibility.     | N                 |
| 3       | Execute a contract with non-existent contract ID   | contractId="0.0.9999999", parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>         | Transaction succeeds because of EVM compatibility.                 | N                 |
| 4       | Execute a contract with deleted contract ID        | contractId=<DELETED_CONTRACT_ID>, parameters=<SET_MESSAGE_FUNCTION_PARAMETERS> | Transaction succeeds because of EVM compatibility.                    | N                 |
...
| 7       | Execute a contract with contract ID as account ID  | contractId=<VALID_ACCOUNT_ID>, parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>    | Transaction succeeds because of EVM compatibility.                 | N                 |
...
| 4       | Execute contract with gas = int64 min               | contractId=<VALID_CONTRACT_ID>, gas="-9223372036854775808", parameters=<SET_MESSAGE_FUNCTION_PARAMETERS> | Fails with internal SDK error.                         | N                 |
| 5       | Execute contract with gas = int64 min + 1           | contractId=<VALID_CONTRACT_ID>, gas="-9223372036854775807", parameters=<SET_MESSAGE_FUNCTION_PARAMETERS> | Fails with internal SDK error.                         | N                 |
| 6       | Execute contract with insufficient gas for function | contractId=<VALID_CONTRACT_ID>, gas="1000", parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>                 | Fails with `INSUFFICIENT_GAS`.                         | N                 |
| 7       | Execute contract with no gas specified              | contractId=<VALID_CONTRACT_ID>, parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>                             | Fails with `INSUFFICIENT_GAS`.                         | N                 |
...
| 2       | Execute contract with zero amount                            | contractId=<VALID_CONTRACT_ID>, amount="0", parameters=<PAYABLE_FUNCTION_PARAMETERS>                    | Transaction succeeds, no amount transferred.          | N                 |
| 3       | Execute contract with negative amount                        | contractId=<VALID_CONTRACT_ID>, amount="-100", parameters=<PAYABLE_FUNCTION_PARAMETERS>                 | Fails with `CONTRACT_NEGATIVE_VALUE`.                 | N                 |
...
| 6       | Execute contract with amount = int64 min                     | contractId=<VALID_CONTRACT_ID>, amount="-9223372036854775808", parameters=<PAYABLE_FUNCTION_PARAMETERS> | Fails with `CONTRACT_NEGATIVE_VALUE`.                 | N                 |
| 7       | Execute contract with amount = int64 min + 1                 | contractId=<VALID_CONTRACT_ID>, amount="-9223372036854775807", parameters=<PAYABLE_FUNCTION_PARAMETERS> | Fails with `CONTRACT_NEGATIVE_VALUE`.                 | N                 |
...
| 9       | Execute contract with no amount specified (defaults to zero) | contractId=<VALID_CONTRACT_ID>, parameters=<PAYABLE_FUNCTION_PARAMETERS>                                | Transaction succeeds, no amount transferred.          | N                 |
| 10      | Execute contract with amount for non-payable function        | contractId=<VALID_CONTRACT_ID>, amount="1000", parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>                 | Fails with `CONTRACT_REVERT_EXECUTED`.                | N                 |
| 11      | Execute contract with zero amount for non-payable function   | contractId=<VALID_CONTRACT_ID>, amount="0", parameters=<SET_MESSAGE_FUNCTION_PARAMETERS>                    | Transaction succeeds, function executed.              | N                 |
