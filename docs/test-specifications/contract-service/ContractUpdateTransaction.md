...
| Test no | Name                                                                                                    | Input                                                                                                                                   | Expected response                                                                                                               | Implemented (Y/N) |
|---------|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|-------------------|
| 1       | Updates the max automatic token associations of a contract to a valid amount                            | contractId=<CREATED_CONTRACT_ID>, maxAutomaticTokenAssociations=100, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]  | The contract update succeeds and the contract has 100 automatic token associations.                                             | N                 |
| 2       | Updates the max automatic token associations of a contract to the minimum amount                        | contractId=<CREATED_CONTRACT_ID>, maxAutomaticTokenAssociations=0, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]    | The contract update succeeds and the contract has 0 automatic token associations.                                               | N                 |
| 3       | Updates the max automatic token associations of a contract to the maximum amount                        | contractId=<CREATED_CONTRACT_ID>, maxAutomaticTokenAssociations=5000, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>] | The contract update succeeds and the contract has 5000 automatic token associations.                                            | N                 |
| 4       | Updates the max automatic token associations of a contract to an amount that exceeds the maximum amount | contractId=<CREATED_CONTRACT_ID>, maxAutomaticTokenAssociations=5001, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>] | The contract update fails with a REQUESTED_NUM_AUTOMATIC_ASSOCIATIONS_EXCEEDS_ASSOCIATION_LIMIT response code from the network. | N                 |
| 5       | Updates the max automatic token associations of a contract to -1 (no limit per HIP-904)                 | contractId=<CREATED_CONTRACT_ID>, maxAutomaticTokenAssociations=-1, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]   | The contract update succeeds and the contract has no limit on automatic token associations.                                     | N                 |
| 6       | Updates the max automatic token associations of a contract to an invalid negative value                 | contractId=<CREATED_CONTRACT_ID>, maxAutomaticTokenAssociations=-2, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]   | The contract update fails with an INVALID_MAX_AUTO_ASSOCIATIONS response code from the network.                                 | N                 |

### **Staked ID:**

- The ID of the account to which the contract is staked.
    - OR
- The ID of the node to which the contract is staked.

| Test no | Name                                                                            | Input                                                                                                                                                                 | Expected response                                                                                     | Implemented (Y/N) |
|---------|---------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|-------------------|
| 1       | Updates the staked account ID of a contract to a valid account ID               | contractId=<CREATED_CONTRACT_ID>, stakedAccountId=<VALID_ACCOUNT_ID>, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                               | The contract update succeeds and the contract has a staking account ID equal to the input account ID. | N                 |
| 2       | Updates the staked node ID of a contract to a valid node ID                     | contractId=<CREATED_CONTRACT_ID>, stakedNodeId=<VALID_NETWORK_NODE_ID>, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                             | The contract update succeeds and the contract has a staking node ID equal to the input node ID.       | N                 |
| 3       | Updates the staked account ID of a contract to an account ID that doesn't exist | contractId=<CREATED_CONTRACT_ID>, stakedAccountId="123.456.789", commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                                    | The contract update fails with an INVALID_STAKING_ID response code from the network.                  | N                 |
| 4       | Updates the staked node ID of a contract to a node ID that doesn't exist        | contractId=<CREATED_CONTRACT_ID>, stakedNodeId="123456789", commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                                         | The contract update fails with an INVALID_STAKING_ID response code from the network.                  | N                 |
| 5       | Updates the staked account ID of a contract to an empty account ID              | contractId=<CREATED_CONTRACT_ID>, stakedAccountId="", commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                                               | The contract update succeeds and the contract is no longer staked to an account.                      | N                 |
| 6       | Updates the staked node ID of a contract to an invalid negative node ID         | contractId=<CREATED_CONTRACT_ID>, stakedNodeId="-100", commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                                              | The contract update fails with an INVALID_STAKING_ID response code from the network.                  | N                 |
| 7       | Updates a contract to set both staked account ID and staked node ID             | contractId=<CREATED_CONTRACT_ID>, stakedAccountId=<VALID_ACCOUNT_ID>, stakedNodeId=<VALID_NODE_ID>, commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>] | The contract update fails with an INVALID_STAKING_ID response code from the network.                  | N                 |
