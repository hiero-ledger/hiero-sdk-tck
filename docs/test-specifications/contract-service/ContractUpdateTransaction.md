...
| 7       | Updates a contract to remove staking by setting default account ID                 | contractId=<CREATED_CONTRACT_ID>, stakedAccountId="", commonTransactionParams.signers=[<ADMIN_KEY_OF_CREATED_CONTRACT>]                                               | Succeeds, contract no longer staked.  | N                 |
