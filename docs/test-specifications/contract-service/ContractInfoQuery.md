...
| 7       | Response contains contract ID                                    | contractId=<VALID_ID>    | Returns contractId matching input                                                             | Y                 |
| 8       | Response contains account ID                                     | contractId=<VALID_ID>    | Returns accountId                                                                             | Y                 |
| 9       | Response contains admin key                                      | contractId=<VALID_ID>    | Returns adminKey (if set)                                                                     | Y                 |
| 10      | Response contains expiration time                                | contractId=<VALID_ID>    | Returns expirationTime                                                                         | Y                 |
| 11      | Response contains auto-renew period                              | contractId=<VALID_ID>    | Returns autoRenewPeriod                                                                        | Y                 |
| 12      | Response contains contract balance                               | contractId=<VALID_ID>    | Returns balance in tinybars                                                                    | Y                 |
| 13      | Response contains contract memo                                  | contractId=<VALID_ID>    | Returns contractMemo (if set)                                                                 | Y                 |
| 14      | Response contains isDeleted flag                                 | contractId=<VALID_ID>    | Returns isDeleted boolean                                                                     | Y                 |
| 15      | Response contains storage information                            | contractId=<VALID_ID>    | Returns storage value                                                                          | Y                 |
| 16      | Response contains contract account ID                            | contractId=<VALID_ID>    | Returns contractAccountId (if applicable)                                                     | Y                 |
| 17      | Response contains auto-renew account ID                          | contractId=<VALID_ID>    | Returns autoRenewAccountId (if set)                                                            | Y                 |
| 18      | Response contains max automatic token associations               | contractId=<VALID_ID>    | Returns maxAutomaticTokenAssociations                                                          | Y                 |
| 19      | Response contains ledger ID                                      | contractId=<VALID_ID>    | Returns ledgerId                                                                               | Y                 |
| 20      | Response contains staking info when applicable                   | contractId=<VALID_ID>    | Returns stakingInfo object with all sub-fields (if staked)                                    | Y                 |
