...
| 16      | Create contract with admin key and maxAutomaticTokenAssociations = 2,147,483,647                      | adminKey=valid, maxAutomaticTokenAssociations=2147483647  | Transaction fails with REQUESTED_NUM_AUTOMATIC_ASSOCIATIONS_EXCEEDS_ASSOCIATION_LIMIT     | N                 |
