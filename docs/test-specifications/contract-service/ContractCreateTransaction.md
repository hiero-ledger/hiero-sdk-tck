...
| 5       | Create contract with admin key and negative gas                                      | adminKey=<VALID_ADMIN_KEY>, gas="-1", commonTransactionParams.signers=[<VALID_ADMIN_KEY>]                         | Fails with internal SDK error.           | N           |
| 6       | Create contract without admin key and negative gas                                   | gas="-1"                                                                                                          | Fails with internal SDK error.           | N           |
...
| 5       | Create a contract that does not have an admin key and that tries to set both stakedAccountId and stakedNodeId present | both fields set                                                                                                         | Succeeds.                             | N           |
...
| 10      | Create a contract that does have an admin key and that tries to set both stakedAccountId and stakedNodeId present     | adminKey=<VALID_ADMIN_KEY>, both fields set, commonTransactionParams.signers=[<VALID_ADMIN_KEY>]                        | Succeeds.                             | N           |
