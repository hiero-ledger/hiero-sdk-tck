...
| 4       | Appends to a deleted file                                                                      | fileId="0.0.1234" (deleted file)                                                                                                    | The file append fails with `INVALID_FILE_ID`.                                                                                    |  N
| 5       | Appends to a file without file ID           |                                      | The file append fails with an INVALID_FILE_ID response code from the network. | N                 |
### **Contents:**
