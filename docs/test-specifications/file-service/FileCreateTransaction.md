...
| 2       | Creates a file with empty contents                         | contents=""                             | The file creation succeeds and creates an empty file.                    | Y                                                    |
...
| 5       | Creates a file with invalid memo                                               | memo="Test\0memo"                    | The file creation fails with `INVALID_ZERO_BYTE_IN_STRING`              | Y                 |
| 6       | Creates a file with memo containing null byte                                  | memo="Test\0memo"                    | The file creation fails with `INVALID_ZERO_BYTE_IN_STRING`              | Y                 |
...
| 8       | Creates a file with memo containing special characters                         | memo="!@#$%^&*()_+-=[]{};':\",./<>?" | The file creation succeeds and the file has the special character memo. | Y                 |
...
| 3       | Creates a file with expiration time equal to current                                        | expirationTime=<CURRENT_TIME>           | The file creation fails with `INVALID_EXPIRATION_TIME`                     | Y                    |
| 4       | Creates a file with too large expiration time                                               | expirationTime=<CURRENT_TIME + 8000002> | The file creation fails with `INVALID_EXPIRATION_TIME`                     | Y                    |
| 5       | Creates a file with expiration time of 9,223,372,036,854,775,807 (`int64` max) seconds      | expirationTime="9223372036854775807"    | The file creation fails with `INVALID_EXPIRATION_TIME`.                    | Y                    |
| 6       | Creates a file with expiration time of 9,223,372,036,854,775,806 (`int64` max - 1) seconds  | expirationTime="9223372036854775806"    | The file creation fails with `INVALID_EXPIRATION_TIME`.                    | Y                    |
...
| 8       | Creates a file with expiration time of -9,223,372,036,854,775,807 (`int64` min + 1) seconds | expirationTime="-9223372036854775807"   | The file creation fails with `INVALID_EXPIRATION_TIME`.                    | Y                    |
...
| 10      | Creates a file with expiration time of 9,000,000 seconds from the current time              | expirationTime=<CURRENT_TIME + 9000000> | The file creation fails with `INVALID_EXPIRATION_TIME`.                    | Y                    |
